...
$artifact = Join-Path $output 'Checkboki-0.1.1-x64.exe'
Copy-Item -LiteralPath $artifact -Destination (Join-Path $destination 'Checkboki-0.1.1-x64.exe') -Force
Write-Host "Created: $(Join-Path $destination 'Checkboki-0.1.1-x64.exe')"
